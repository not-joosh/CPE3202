 /*======================================================================================================
* FILE        : Cadungog_Commendador_Lucenara_Ratificar_CU.c
...
* DESCRIPTION : This program simulates the Control Unit of the Arithmetic Logic Unit (ALU).
...
/*===============================================
*   FUNCTION    :   CU
*   DESCRIPTION :   This function is the Control Unit of the ALU.
*   ARGUMENTS   :   VOID
*   RETURNS     :   INT
 *==============================================*/
int CU()
...
*   DESCRIPTION :   This function displays the data in the ALU.
...
/*===============================================
*   FUNCTION    :   initMemory
*   DESCRIPTION :   This function initializes the main memory of the ALU.
*   ARGUMENTS   :   VOID
*   RETURNS     :   VOID
 *==============================================*/
void initMemory()
